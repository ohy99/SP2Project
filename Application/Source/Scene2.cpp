...
//Scene2::Text_Data Scene2::Text[TEXT_TYPE::Text_Count];
//unsigned Scene2::m_parameters[U_TOTAL];
MS Scene2::modelStack, Scene2::viewStack, Scene2::projectionStack;

//std::vector<GameObject*> Scene2::Game_Objects_(10, NULL);

//std::vector<GameObject*> Scene2::Game_Objects_(10, NULL);
//UI renderMeshOnScreen;
std::vector<EnvironmentObj*> Scene2::Env_Obj;
std::vector<NPC*> Scene2::CampNPC;
