...
public:
	...
	static void RMoS_RadarUse(Mesh* mesh, Vector3 origin, Vector3 dirRelativeToOrigin, Vector3 dir, int sizex, int sizey, float scale, MS* projectionStack, MS* viewStack, MS* modelStack, unsigned * m_parameters);
};
#endif